...
const DetailProduct = ( props: Iporps ) =>
{
    const { _id } = useParams()
    ...
    useEffect( () =>
    {
        const cureenProduct = props.products.find( ( product ) => product._id === String( _id ) )
                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="pb-2">
                            ...
                            <span className="title-font font-medium text-[14px] text-[#707070]"></span>
                        </div>
                        ...
                        <p className="leading-relaxed"> { product?.original_price } </p>
                        ...
                        <div className="flex">
                            <a href="/giohang"> <button className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Mua Ngay</button> </a>
